...
Return to Zephyr's Getting Started Guide and [Install Zephyr SDK](https://docs.zephyrproject.org/4.4.1/develop/getting_started/index.html#install-zephyr-sdk).
